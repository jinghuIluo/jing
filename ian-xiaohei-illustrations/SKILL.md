...
description: Use when 用户需要为中文文章、帖子、博客、Notion 文档、工作流、方法论、流程、结构、状态、隐喻或观点设计“怪诞手绘”“正文配图”“文章插图”“配图建议”“shot list”或去标题改图；默认使用已确认的 Ian 本人卡通 IP。
---
...
默认视觉 IP 是已确认的 Ian 本人卡通形象：短黑发、辨识度明确的本人脸部、轻胡茬、黑色圆领 T 恤和黑裤，表情冷静认真。人物必须参与画面的核心动作，不能只是站在旁边当装饰。生成或编辑图片时，把 `assets/character/ian-character-sheet.png` 作为固定人物参考图；未经用户重新确认，不得自行改造人物脸型、发型、服装或整体气质。
...
- `references/ian-persona-ip.md`：Ian 本人卡通 IP 的形象、识别点、动作库和禁忌。
...
- 大量留白
- Ian 本人卡通人物作为核心动作主体
- 使用 `assets/character/ian-character-sheet.png` 锁定人物身份与造型
- 禁止 PPT、商业插画、幼稚可爱、复杂架构、左上角类型标题

不要复刻过往案例。案例只提供风格密度和人物参与方式，不能直接复用“传送带断点 / 人物拉线 / 素材鱼 / 盖章工具箱 / 常见坑路径”等已有构图，除非用户明确要求复刻某张图。每次都要从当前文章重新发明一个奇怪但成立的隐喻。
