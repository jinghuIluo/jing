...
- 背景是干净白底。
- 有 Ian 本人卡通人物。
- 人物与 `assets/character/ian-character-sheet.png` 的脸型、短发、轻胡茬、黑色圆领和冷静气质一致。
- 人物承担核心动作，不只是装饰。
...
- 人物像通用男性、吉祥物、表情包或可爱卡通，缺少本人辨识度。
- 同一张图里的多个人物出现脸型、发型、服装漂移。
- 画面像 PPT、课程课件、正式流程图。
- 元素太多、箭头太多、节点太多。
- 文字变成大段解释。
- 背景有纸纹、阴影、渐变、米色、噪点。
